...
export class DeviceInfoService {
    ...
    //     return this._req.request<DeviceStaticInfoResponse>( {
    //         url: `api/device/info/get?id=${id}`,
    //         method: RequestMethodType.get,
    //     });
    // }

    public getRange(start: number, count: number): Observable<HttpResponse<DeviceStaticInfoResponse[]>> {
        return this._req.request<DeviceStaticInfoResponse[]>( {
    ...
    public getAll(): Observable<HttpResponse<DeviceStaticInfoResponse[]>> {
        return this._req.request<DeviceStaticInfoResponse[]>( {
